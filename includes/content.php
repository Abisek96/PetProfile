    ...
    <div id="lp-register">
        ...
        <div class="row">
            ...
            <div class="intro-texts">
            	<h1 class="text-white">Create Memories of Your Pets!!!</h1>
            <p>Pet profiler is a social networking site where you can show the world how you are having fun with your pets. Show your love towards your pet! Just Sign in for free and enjoy the Pet World!!!  <br /> <br />This is time to show love towards our pets.</p>
            ...
            <div class="reg-form-container"> 
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="register">
                  <h3>Register Now !!!</h3>
                  <p class="text-muted">Join Today. Meet another Pet</p>
                  
                  <!--Register Form-->
                  <form method="post" action="" name="registration_form" id='registration_form' class="form-inline">
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="form-group col-xs-12">
                        ...
                        <input id="email" class="form-control input-group-lg" type="email" name="Email" title="Enter Email" placeholder="Your Email"/>
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-xs-12">
                  ...
                  <form method="post" action="" name="Login_form" id='Login_form'>
                    ...
                    <div class="row">
                      <div class="form-group col-xs-12">
                        ...
                        <font color="white">Login Now</font></a></button>
                      </div>
                    </div>
